...
const Dashboard = () => {
  ...
  return (
    <div className="p-6 w-screen w-full">
      <h1 className="text-3xl my-24 font-bold text-black mb-4">Dashboard</h1>

      {transactions.length > 0 ? (
        <div className="bg-white shadow-md rounded-lg p-4">
          <h2 className="text-xl text-black font-semibold mb-3">Transaction Details</h2>
